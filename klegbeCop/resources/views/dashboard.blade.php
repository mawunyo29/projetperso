<x-app-layout class="bg-gray-100 w-full  ">
    <x-slot name="header">
    ...
    <div class="mx-auto sm:px-6 lg:px-8 py-12 relative md:ml-20 bg-blueGray-50">
                        ...
                        <div class="items-center flex">
                            <span
                                class="w-12 h-12 text-sm text-white bg-blueGray-200 inline-flex items-center justify-center rounded-full"><img
                                    ...
                                    src="./img/team-1-800x800.jpg" /></span>
                        </div>
                    </a>
        ...
        <div class=" ">
            <div class="flex flex-wrap">
                <div class="w-full xl:w-8/12 mb-12 xl:mb-0 -mt-24 p-3  ">
                    <div
                        class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded ">
                        <div class="rounded-t mb-0 px-4 py-3 bg-white">
                            <div class="flex flex-wrap items-center">
                                <div class="relative w-full max-w-full flex-grow flex-1">
                                    <h6 class="uppercase text-gray-800 mb-1 text-xs font-semibold">
                                        Overview
                                    </h6>
                                    <h2 class="text-blue-700 text-xl font-semibold">
                                        Sales value
                                    </h2>
                                </div>
                            </div>
                        </div>
                        <div class="p-4 flex-auto bg-gray-700 ">
                            <!-- Chart -->
                ...
                <div class="w-full xl:w-4/12 -mt-24  p-3">
            ...
            <div class="flex flex-wrap mt-4">
                <div class="w-full xl:w-8/12 mb-12 xl:mb-0 p-3">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
                ...
                <div class="w-full xl:w-4/12 p-3">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded  ">
                        <div class="rounded-t mb-0 px-4  py-3 border-0">
                            <div class="flex flex-wrap items-center">
                                <div class="relative w-full px-4 max-w-full flex-grow flex-1">
