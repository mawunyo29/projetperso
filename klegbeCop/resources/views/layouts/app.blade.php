...
<body class="font-sans antialiased">
    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <!-- Page Content -->
        <main >
            <nav class="md:text-xs uppercase py-3 font-bold  md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl lateral_togger bg-white flex flex-wrap items-center justify-between   px-6"
                id="mylateral_navbar" navlateral>
                <div class=" md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0   items-center justify-between w-full mx-auto"
